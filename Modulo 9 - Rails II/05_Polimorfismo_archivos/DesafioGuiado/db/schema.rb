...
ActiveRecord::Schema.define(version: 2022_07_16_005504) do

  create_table "animals", force: :cascade do |t|
    t.string "name"
    t.string "breed_type", null: false
    t.integer "breed_id", null: false
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["breed_type", "breed_id"], name: "index_animals_on_breed"
  end
  ...
  create_table "mixeds", force: :cascade do |t|
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
  end
